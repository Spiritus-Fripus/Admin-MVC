                ...
                <tr>
                    ...
                    <td>
                        ...
                        <div class="button-crud">
                            <a href="?controller=user&action=userInfo&user_id=<?= $row['user_id'] ?>" class="see">
                            ...
                            <a href="?controller=user&action=updateUser&user_id=<?= $row['user_id'] ?>" class="modify">
                                <svg xmlns="http://www.w3.org/2000/svg" height="20px" viewBox="0 -960 960 960" width="20px" fill="#e8eaed">
                            ...
                            <?php if ($row['user_mail'] !== $_SESSION['user_mail']) { ?>
                                <a href="?controller=user&action=archiveUser&user_id=<?= $row['user_id'] ?>" class="delete">
                                    <svg xmlns="http://www.w3.org/2000/svg" height="20px" viewBox="0 -960 960 960" width="20px" fill="#e8eaed">
